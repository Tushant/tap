...
const campaigns = [
...

	{
		...
		ads: [
				...
				personas: [
					{
						...
						scores: [
							{ score: 42, text: '####% overall' },
							{
								score: 81,
								text:
									'####% top topic [[Coffeehouse Enlightenment|||boards/123456]]'
							}
						]
					},
					{
					...
					},
					{
						...
						scores: [
							{ score: 75, text: '####% overall' },
							{
								score: 85,
								text:
									'####% top topic [[Small Apartment Living|||boards/567890]]'
							}
						]
					}
				]
			...
			{
				name:
					"Better Homes and Gardens Magazine Spring Ad for Susan's New Deisgns", // ad 5
				scores: [52, 63],
				personas: []
			}
		]
				...
				>
					<div className="adContentContainer">
						...
						<p>
							...
							<span>
								<FaPlusCircle
									onClick={() => this.handlePersonasClick(ad.personas)}
								/>
							</span>
						</p>
